...
public class ScheduleTableView {
    ...
    private List<JButton> createToolbarButtons() {
        ...
        JButton trainsButton = createToolbarButton("Trains");
        trainsButton.addActionListener(e -> showTrainView());
        buttons.add(trainsButton);

        JButton statisticsButton = createToolbarButton("Statistiques");
        statisticsButton.addActionListener(e -> showStatisticsView());
